...
public class TileWorld {
	...
	public void keyPressed(KeyEvent kev) {
		...
		if (Character.toLowerCase(kev.getKey()) == 'n') {
			...
			this.rearrange(20);
		} else if (Character.toLowerCase(kev.getKey()) == '>') {
			this.sortTiles();
		} else if (Character.toLowerCase(kev.getKey()) == '<') {
			this.sortReverse();
		} else if (Character.toLowerCase(kev.getKey()) == '1') {
			this.comp = new NameComparator();
		} else if (Character.toLowerCase(kev.getKey()) == '2') {
			this.comp = new AreaComparator();
		}
		    */
	}
